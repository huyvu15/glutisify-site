    ...
    <footer className="bg-[#009245] text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12" ref={ref}>
          ...
          >
            ...
            <ul className="space-y-4 text-[16px]">
              <li><a href="/" className="hover:underline transition-all">Trang chủ</a></li>
              <li><a href="/about" className="hover:underline transition-all">Giới thiệu</a></li>
              <li><a href="/contact" className="hover:underline transition-all">Liên hệ hợp tác</a></li>
              <li><a href="/jobs" className="hover:underline transition-all">Tuyển dụng</a></li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-4 text-[16px]">
              <li><a href="/policy" className="hover:underline transition-all">Chính sách bảo mật</a></li>
              <li><a href="/payment" className="hover:underline transition-all">Chính sách thanh toán</a></li>
              <li><a href="/affiliate" className="hover:underline transition-all">Chính sách Affiliate</a></li>
              <li><a href="/terms" className="hover:underline transition-all">Điều khoản dịch vụ</a></li>
              <li><a href="/disclaimer" className="hover:underline transition-all">Tuyên bố từ chối trách nhiệm</a></li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-col space-y-4">
              <div className="flex items-center space-x-2 grayscale brightness-200 opacity-80 hover:grayscale-0 hover:opacity-100 transition-all cursor-pointer">
                <span className="font-bold text-xl italic">SmaxBot</span>
              </div>
              <div className="flex items-center space-x-2 grayscale brightness-200 opacity-80 hover:grayscale-0 hover:opacity-100 transition-all cursor-pointer">
                <span className="font-bold text-xl italic">SmaxChat</span>
              </div>
              <div className="flex items-center space-x-2 grayscale brightness-200 opacity-80 hover:grayscale-0 hover:opacity-100 transition-all cursor-pointer">
                <span className="font-bold text-xl italic text-blue-200">Smax.App</span>
              </div>
              <div className="flex items-center space-x-2 grayscale brightness-200 opacity-80 hover:grayscale-0 hover:opacity-100 transition-all cursor-pointer">
                <span className="font-bold text-xl italic text-orange-200">Smir</span>
              </div>
              <div className="flex items-center space-x-2 grayscale brightness-200 opacity-80 hover:grayscale-0 hover:opacity-100 transition-all cursor-pointer">
                <span className="font-bold text-xl italic text-red-200">BotPlus</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex space-x-4 mb-10">
              <a href="#" className="w-10 h-10 bg-[#1877F2] rounded-full flex items-center justify-center hover:scale-110 transition-all">
                <Facebook size={20} fill="white" className="text-white" />
              </a>
              <a href="#" className="w-10 h-10 bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] rounded-full flex items-center justify-center hover:scale-110 transition-all">
                <Instagram size={20} className="text-white" />
              </a>
              <a href="#" className="w-10 h-10 flex items-center justify-center hover:scale-110 transition-all">
                <div className="bg-[#FF0000] p-1.5 rounded-lg flex items-center justify-center">
                  <Youtube size={20} fill="white" className="text-white" />
                </div>
              </a>
              <a href="#" className="w-10 h-10 bg-black rounded-full flex items-center justify-center hover:scale-110 transition-all">
        ...
        <div className="border-t border-white/10 pt-8 mt-8 flex flex-col md:flex-row justify-between items-center text-sm text-white/60">
          <p>© 2024 Glutisify. All rights reserved.</p>
